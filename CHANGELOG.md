...
* **oss:** update template issue typo ([92ed033](https://github.com/zetapush/zetapush/commit/92ed033))
* **oss:** update template issue typo ([c0f3eba](https://github.com/zetapush/zetapush/commit/c0f3eba))


### Features

* **platform:** supported autogenerated services and configurer ([237c0b9](https://github.com/zetapush/zetapush/commit/237c0b9))
