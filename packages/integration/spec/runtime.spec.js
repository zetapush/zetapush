...
describe(`As developer with 
  ...
  it (`Should be able to launch a local worker and call hello CCS`, async () => {
    copydir.sync('spec/templates/'+basicWorkerDir, '.generated-projects/'+basicWorkerDir);
    createZetarc(this.developerLogin, this.developerPassword, '.generated-projects/'+basicWorkerDir);
  ...
  it (`Should be able to catch a broken worker init`, async () => {
    copydir.sync('spec/templates/'+brokenWorkerInitDir, '.generated-projects/'+brokenWorkerInitDir);
    createZetarc(this.developerLogin, this.developerPassword, '.generated-projects/'+brokenWorkerInitDir);
  ...
  it (`Should be able to catch an exit CCS `, async () => {
    copydir.sync('spec/templates/'+exitWorkerDir, '.generated-projects/'+exitWorkerDir);
    createZetarc(this.developerLogin, this.developerPassword, '.generated-projects/'+exitWorkerDir);
  ...
  it (`Should be able to catch a shutowned worker `, async () => {
    copydir.sync('spec/templates/'+shutdownWorkerDir, '.generated-projects/'+shutdownWorkerDir);
    createZetarc(this.developerLogin, this.developerPassword, '.generated-projects/'+shutdownWorkerDir);
